public class ej25 {
    ...
    public static void main(String[] args) {
        int[] arr = {0, 2, 3, 0, 5, 6, 7, 8, 0, 0, 1, 2, 3, 4, 0, 5,
6, 0, 0, 0};
        procesar(arr);
    }
    ...
    public static void procesar(int[] arr) {
        ...
        if (contadorSecuencias >= 2) {
            ...
            System.out.println("La anteúltima secuencia empieza en: "
+ inicioAnteultima + " y termina en: " + finAnteultima);
        } else {
            System.out.println("No hay suficientes secuencias para
encontrar la anteúltima.");
        }
    }
